...
export const FloatingActionDock: React.FC<FloatingActionDockProps> = ({ 
  ...
  return (
    <div className="fixed bottom-10 left-1/2 -translate-x-1/2 z-[450] flex items-center justify-center pointer-events-none">
      {/* Container Principal com Glassmorphism Extremo */}
      <div className="flex items-center px-4 py-3 bg-white/[0.03] backdrop-blur-[40px] rounded-[48px] border border-white/10 shadow-[0_25px_80px_rgba(0,0,0,0.8)] space-x-2 animate-in slide-in-bottom duration-700 pointer-events-auto">
