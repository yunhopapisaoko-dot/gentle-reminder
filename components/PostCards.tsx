...
export const FeaturedCard: React.FC<{ post: Post }> = ({ post }) => {
  return (
    <div className="mx-6 my-6 relative rounded-[40px] overflow-hidden group border border-white/10 shadow-[0_30px_60px_rgba(0,0,0,0.5)] bg-surface-purple">
      <div className="aspect-[16/11] relative overflow-hidden">
        ...
        <div className="absolute bottom-0 inset-x-0 p-8">
          <h2 className="text-3xl font-black text-white mb-3 leading-[1.1] tracking-tighter drop-shadow-2xl">{post.title}</h2>
